	...
	protected void handleMessageFromClient(Object msg, ConnectionToClient client) {
		   ...
		   String msgg;
		     if(msg.toString().equals("show"))
			{
			 ...
			 {
				 		msgg = msg.toString().replace("the first wrong answer is:","");
						newQuestion.add(msgg);	
						try {
			 ...
			 if (msg.toString().startsWith("the third wrong answer is:")){
			 		msgg = msg.toString().replace("the third wrong answer is:","");
					newQuestion.add(msgg);	
			 ...
			 if (msg.toString().startsWith("show the updated question")){
				 ...
				 try {
				    ...
				    client.sendToClient("type show if you want to see all the questions and edit more questions.");
				 } catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
